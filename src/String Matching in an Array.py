...
class AhoTrie(object):
    def step(self, letter):
        ...
        self.__node = self.__node.children[
            letter] if self.__node else self.__root
    ...
    def __create_ac_suffix_and_output_links(self,
                                            root):  # Time:  O(n), Space: O(t)
...
t = Solution()
print(t.stringMatching(["mass", "as", "hero", "superhero"]))
